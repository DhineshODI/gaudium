...
export default function NewsandEvents({ menuOnclick }) {
  const games = [
    {
      id: 1,
    ...
    <>
      ...
      <div className="aboutPage">
        <div className="bannerimagesection newsandeventsbanner">
          ...
          <p className="mainheadingfont banneroverlaytextall">News & Events</p>
        </div>
      </div>
      {/* Banner-Image */}
              ...
              {games.map((game) => (
                <div className="outdoorsportscards">
                  ...
                  <div className="flexdiourprogrem">
                    ...
                    <p className="secondheadingtext">{game.gameAboutContent}</p>

                    <a className="exploremorebutton buttonfont">explore More</a>
                  </div>
                </div>
              ))}
            </div>
