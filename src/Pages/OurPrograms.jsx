        ...
        <div className="container max-w-7xl mx-auto px-4 ">
          ...
          <div ref={sectionRef1}>
            <div className="programsbuiltcard">
              <div className="porgramsofferedcontent">
                ...
                <p className="paragraphtext paragaoneprogram">
                  ...
                  shared during Sportopia PTMs. Designed to nurture confidence,
                  coordination, and a love for sport in young learners. Ideal
                  for beginners seeking structured exposure alongside academics.
                </p>
            ...
            <div className="programsbuiltcard secondoneprogrammer">
              <div className="porgramsofferedcontent">
                <p className="nameofthesportsprogramm">Sportopia</p>
                <h3 className="roleinstrength">Stellar</h3>
                <p className="paragraphtext paragaoneprogram">
                  ...
                  high-performance and specialist coaching. Built for committed
                  athletes ready to elevate performance through disciplined
                  training. Emphasizes competitive readiness, physical
                  conditioning, and tactical development.
                </p>
            ...
            <div className="programsbuiltcard thirdoneprogrammer">
              <div className="porgramsofferedcontent">
                ...
                <p className="paragraphtext paragaoneprogram">
                  ...
                  exposure to high-level competition. Created for future
                  professionals pursuing excellence at national and
                  international levels. Provides a holistic pathway combining
                  elite sport, academics, and career-focused mentorship.
                </p>
